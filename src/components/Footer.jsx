            ...
            <footer className="min-w-full">
                <div className="flex flex-col items-center justify-center gap-6 p-4 lg:flex-row -mt-10 -mb-10">
                    <div className="lg:pl-40 pl:0 text-center md:text-left">
                        ...
                        <div className="mt-2 text-center text-xl">Rental penyedia jasa untuk acara dengan mudah</div>
                    </div>
                    <div className="lg:pl-40 pl-0 text-center lg:text-left">
                        <div className="mt-2 text-xl font-bold ">Address :</div>
                        <div className="mt-2 text-xl ">Jl. Babarsari No.43, Janti, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281</div>
                        <div className="mt-4 text-xl font-bold ">Customer Service RENCARA :</div>
                        <div className="mt-2 text-xl">(+62) 812-5566-7780</div>
                        <div className="mt-1 text-xl font-bold">Email :</div>
                        <div className="mt-2 text-xl">rencara@gmail.com</div>
